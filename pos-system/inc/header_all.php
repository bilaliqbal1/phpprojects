    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="./category.php"><i class="fa fa-list-alt"></i> <span>Products categories</span></a></li>
          <li><a href="./satuan.php"><i class="fa fa-balance-scale"></i> <span>Products list</span></a></li>
          <li><a href="./register.php"><i class="fa fa-users"></i> <span>Applicaiton user</span></a></li>
