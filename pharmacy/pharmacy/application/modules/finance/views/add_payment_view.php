    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            <header class="panel-heading">
              ...
              <?php
                    $message = $this->session->flashdata('sufficient');
                    if (!empty($message)) {
                        ?>
                        <div class="pull-right sufficient"> <?php echo $message; ?></div>
                    <?php } ?> 
                </header>
                <div class="">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="category_name[]" id="" class="multi-select" multiple="" id="my_multi_select3" >
                                                                <?php foreach ($medicines as $medicine) { ?>
                                                                    <option class="ooppttiioonn" data-id="<?php echo $medicine->id; ?>" data-s_price="<?php echo $medicine->s_price; ?>" data-m_name = "<?php echo $medicine->name; ?>" value="<?php echo $medicine->id; ?>"
                                                                    <?php
